...
static Scanner input = new Scanner(System.in);
    ...
    public static void main(String[] args) {
        ...
        do
        {
            ...
            case "2":
                    ...
                    break;
            case "3":
                    changeAttributes(playlist);
                    break;
            case "4":
                    showRatingSummary(playlist);
                    break;
            case "5":
                    searchVideosWithKeyword(playlist);
                    break;
            case "6":
                    showVideosMinimumRating(playlist);
                    break;
            default:
    ...
    public static void addVideoToPlaylist(Playlist playlist)
    {
    ...
    public static void changeAttributes(Playlist playlist)
    {
    ...
    public static void showRatingSummary(Playlist playlist)
    {
    ...
    public static void searchVideosWithKeyword(Playlist playlist)
    {
    ...
    public static void showVideosMinimumRating(Playlist playlist)
    {
